...
async def get_faction_autocomplete(ctx: AutocompleteContext) -> list[str]:
    """
    Fetches a list of faction names for autocomplete suggestions.
    Args:
        ctx (AutocompleteContext): The context for the autocomplete interaction.
    Returns:
...
async def get_arena_type_autocomplete(ctx: AutocompleteContext) -> list[str]:
    """
    ...
    Args:
        ctx (AutocompleteContext): The context in which the autocomplete is being requested.
    Returns:
