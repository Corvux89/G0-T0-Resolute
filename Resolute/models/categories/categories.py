...
char_class = CompendiumObject(
    "character_class", CharacterClass, c_character_class_table, CharacterClassSchema
)
...
char_archetype = CompendiumObject(
    "archetype",
    CharacterArchetype,
    c_character_archetype_table,
...
char_species = CompendiumObject(
    "species", CharacterSpecies, c_character_species_table, CharacterSpeciesSchema
)
...
arena_tier = CompendiumObject(
    "arena_tier", ArenaTier, c_arena_tier_table, ArenaTierSchema
)
...
dashboard_type = CompendiumObject(
    "dashboard_type", DashboardType, c_dashboard_type_table, DashboardTypeSchema
)
...
cc_conversion = CompendiumObject(
    "cc_conversion", CodeConversion, c_code_conversion_table, CodeConversionSchema
)
...
arena_type = CompendiumObject(
    "arena_type", ArenaType, c_arena_type_table, ArenaTypeSchema
)
...
transaction_type = CompendiumObject(
    "transaction_type", TransactionType, c_transaction_type_table, TransactionTypeSchema
)
...
transaction_subtype = CompendiumObject(
    "transaction_subtype",
    TransactionSubType,
    c_transaction_subtype_table,
...
level_cost = CompendiumObject(
    "level_cost", LevelCost, c_level_cost_table, LevelCostSchema
)
...
activity_points = CompendiumObject(
    "activity_points", ActivityPoints, c_activity_points, ActivityPointsSchema
)
