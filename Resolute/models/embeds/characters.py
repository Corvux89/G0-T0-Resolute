...
class NewCharacterSetupEmbed(discord.Embed):
    def __init__(self, player: Player, new_character: PlayerCharacter, newClass: PlayerCharacterClass, 
...
class NewcharacterEmbed(discord.Embed):
    def __init__(self, log: DBLog):
        ...
        self.description = f"**Player**: {log.player.member.mention}\n"\
        ...
        self.set_footer(text=f"Created by: {log.author.member.name} - Log #: {log.id}",
